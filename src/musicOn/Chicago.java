...
public class Chicago extends JPanel implements ActionListener {
    ...
    public Chicago() {
        ...
        // 배경 이미지 로드
        try {
            backgroundImage = new ImageIcon("src/img/bg/chicagoInGame.png").getImage();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void startGame() {
        ...
        // 배경 음악 로드 및 재생
        playBackgroundMusic("src/songs/WeBothReachedForTheGun.wav");
    ...
    private void showFinalScore() {
        ...
        try {
            db.saveScore("chicago", score); // 점수 저장
        ...
        Ending endingPanel = new Ending(score, "chicago");
