...
public class Wicked extends JPanel implements ActionListener {
    ...
    public Wicked() {
        ...
        // 배경 이미지 로드
        try {
            backgroundImage = new ImageIcon("C:\\MusicON\\src\\img\\bg\\wickedInGame.png").getImage();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void startGame() {
        ...
        // 배경 음악 로드 및 재생
        playBackgroundMusic("C:\\MusicON\\src\\songs\\Popular.wav");
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color customColor = new Color(0x8EBC1B); // #FF5733 색상
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Wicked");
        Wicked game = new Wicked();
